      ...
      body: [
        {
          ...
          id: 'ps1',
          items: [
            { letter: 'A', label: '乘客正在乘坐高铁', image: 'tblt-hsk4/u06/c1-a.png' },
            { letter: 'B', label: '乘客用护照通过检票口', image: 'tblt-hsk4/u06/c1-b.png' },
            {
              letter: 'C',
              label: '乘务员要旅客出示身份证',
              image: 'tblt-hsk4/u06/c1-c.png',
            },
            {
              letter: 'D',
              label: '西安去南京，需要在郑州换乘',
              image: 'tblt-hsk4/u06/c1-d.png',
            },
          ],
        },
      ...
      body: [
        {
          ...
          id: 'ps1',
          items: [
            { letter: 'A', label: '拿出“支付宝”付款码', image: 'tblt-hsk4/u06/c2-a.png' },
            { letter: 'B', label: '用现金支付', image: 'tblt-hsk4/u06/c2-b.png' },
            { letter: 'C', label: '拿出“微信支付”付款码', image: 'tblt-hsk4/u06/c2-c.png' },
            { letter: 'D', label: '刷信用卡', image: 'tblt-hsk4/u06/c2-d.png' },
          ],
        },
        { kind: 'numberedBlanks', ids: ['b1', 'b2', 'b3', 'b4'] },
      ],
