...
const MANUAL = {
  ...
  'openInLanguagePlayer': {
    ...
    'af': 'Maak oop in Language Player', 'ar': 'فتح في Language Player',
    'ca': 'Obre a Language Player', 'de': 'In Language Player öffnen',
    'el': 'Άνοιγμα στο Language Player', 'es': 'Abrir en Language Player',
    'fi': 'Avaa Language Playerissä', 'ga': 'Oscail in Language Player',
    'hi': 'Language Player में खोलें', 'hr': 'Otvori u Language Playeru',
    'hu': 'Megnyitás a Language Playerben', 'id': 'Buka di Language Player',
    'it': 'Apri in Language Player', 'ko': 'Language Player에서 열기',
    'nl': 'Openen in Language Player', 'no': 'Åpne i Language Player',
    'pl': 'Otwórz w Language Player', 'pt': 'Abrir no Language Player',
    'ro': 'Deschide în Language Player', 'ru': 'Открыть в Language Player',
    'sr': 'Отвори у Language Player-у', 'sv': 'Öppna i Language Player',
    'sw': 'Fungua katika Language Player', 'th': 'เปิดใน Language Player',
  ...
  'hideTranscript': {
    ...
    'af': 'Verberg Transkripsie', 'ar': 'إخفاء النص',
    'ca': 'Amaga la transcripció', 'de': 'Transkript ausblenden',
    'el': 'Απόκρυψη απομαγνητοφώνησης', 'es': 'Ocultar transcripción',
    'fi': 'Piilota transkriptio', 'ga': 'Folaigh an tras-scríbhinn',
    'hi': 'ट्रांसक्रिप्ट छिपाएं', 'hr': 'Sakrij transkript',
    'hu': 'Átirat elrejtése', 'id': 'Sembunyikan Transkrip',
    'it': 'Nascondi trascrizione', 'ko': '스크립트 숨기기',
    'nl': 'Transcriptie verbergen', 'no': 'Skjul transkripsjon',
    'pl': 'Ukryj transkrypcję', 'pt': 'Ocultar transcrição',
    'ro': 'Ascunde transcrierea', 'ru': 'Скрыть транскрипт',
    'sr': 'Сакриј транскрипт', 'sv': 'Dölj transkribering',
    'sw': 'Ficha Nakala', 'th': 'ซ่อนบทถอดความ',
  ...
  'watchInLanguagePlayer': {
    ...
    'af': 'Kyk in Language Player', 'ar': 'شاهد في Language Player',
    'ca': 'Mira a Language Player', 'de': 'In Language Player ansehen',
    'el': 'Παρακολούθηση στο Language Player', 'es': 'Ver en Language Player',
    'fi': 'Katso Language Playerissä', 'ga': 'Féach in Language Player',
    'hi': 'Language Player में देखें', 'hr': 'Gledaj u Language Playeru',
    'hu': 'Megnézés a Language Playerben', 'id': 'Tonton di Language Player',
    'it': 'Guarda in Language Player', 'ko': 'Language Player에서 시청',
    'nl': 'Bekijken in Language Player', 'no': 'Se i Language Player',
    'pl': 'Oglądaj w Language Player', 'pt': 'Assistir no Language Player',
    'ro': 'Vizionează în Language Player', 'ru': 'Смотреть в Language Player',
    'sr': 'Гледај у Language Player-у', 'sv': 'Titta i Language Player',
    'sw': 'Tazama katika Language Player', 'th': 'รับชมใน Language Player',
  ...
  'readInLanguagePlayer': {
    ...
    'af': 'Lees in Language Player', 'ar': 'اقرأ في Language Player',
    'ca': 'Llegeix a Language Player', 'de': 'In Language Player lesen',
    'el': 'Ανάγνωση στο Language Player', 'es': 'Leer en Language Player',
    'fi': 'Lue Language Playerissä', 'ga': 'Léigh in Language Player',
    'hi': 'Language Player में पढ़ें', 'hr': 'Čitaj u Language Playeru',
    'hu': 'Olvasás a Language Playerben', 'id': 'Baca di Language Player',
    'it': 'Leggi in Language Player', 'ko': 'Language Player에서 읽기',
    'nl': 'Lezen in Language Player', 'no': 'Les i Language Player',
    'pl': 'Czytaj w Language Player', 'pt': 'Ler no Language Player',
    'ro': 'Citește în Language Player', 'ru': 'Читать в Language Player',
    'sr': 'Читај у Language Player-у', 'sv': 'Läs i Language Player',
    'sw': 'Soma katika Language Player', 'th': 'อ่านใน Language Player',
