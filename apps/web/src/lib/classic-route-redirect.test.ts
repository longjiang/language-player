...
describe('classicRouteAction', () => {
  describe('v2RedirectPath normalizes Chinese-related L2 to zh', () => {
    it.each([
      ...
      ['/en/ja/chinese/explore-related', '/en/zh/chinese/explore-related'],
      ['/en/ja/chinese/explore-roots/123', '/en/zh/chinese/explore-roots/123'],
      ['/en/ja/chinese/explore-topics', '/en/zh/chinese/explore-topics'],
      ['/en/ja/chinese/idioms', '/en/zh/chinese/idioms'],
      ...
      ['/en/ja/lesson-videos/1/2', '/en/zh/lesson-videos/1/2'],
  ...
  describe('renamed routes map to their web equivalent', () => {
    it.each([
      ...
      ['/en/ja/youtube/channels', '/en/ja/channels'],
      ['/en/ja/youtube/subscriptions', '/en/ja/my-channels'],
