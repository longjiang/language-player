 ...
 *
 * For Chinese (zh, yue, lzh): swaps head ↔ alternate based on the user's
 *   traditional/simplified setting.
 * For Vietnamese (vi) / Korean (ko): shows chữ Hán / hanja from han_script.han.
 * All other languages: no alternate script.
 *
 * Ported from web's useScriptPreference — uses mobile SettingsContext.
 */
