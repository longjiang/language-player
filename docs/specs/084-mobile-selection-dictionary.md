...
- **Plan**:
  ...
  3. Fixed paragraph metrics: `setLineSpacing`/`setIncludeFontPadding` to reproduce `lineHeight` (base line + reserved reading slot), `setTextDirection` for `isRtl`.
