...
> **Full schema documentation**: See [`docs/arch/004-python-dictionary-db-schema.md`](./004-python-dictionary-db-schema.md) for complete table schemas, ID formats, classifier format, and lookup strategies.
