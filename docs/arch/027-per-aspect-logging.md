...
| `settings` | `settingsLogger` | Settings modal (ADR-0042): open/close, resolved sheet/dialog shape, category switches — `components/settings/SettingsDialog.tsx`, `contexts/SettingsDialogContext.tsx` (web twin in `apps/web/src/components/settings/settings-dialog.tsx`) | global |
